...
algo_list = ['Bubble Sort', 'Merge Sort','Insertion Sort','Selection Sort','Heap Sort','Quick Sort','Shell Sort','Comb Sort','Exchange Sort','Counting Sort','Bucket Sort','Radix Sort']
...
### User interface here ###
UI_frame = Frame(window, width= 900, height=300, bg=DARK_BLUE)
